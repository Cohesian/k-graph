...
| [`RESOURCE-CONTRACT-V2.md`](RESOURCE-CONTRACT-V2.md) | Active hierarchical resource keys, protocols, and digests |
...
The normative repository boundary is [`../CONTRACT.md`](../CONTRACT.md). The
current graph, validator, and Neo4j generator implement resource protocol v2.
